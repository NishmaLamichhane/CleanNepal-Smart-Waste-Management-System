...
<div class="container mx-auto px-4 py-8 max-w-3xl">
    ...
    <div class="mb-8">
        ...
        <p class="mt-3 text-gray-600 dark:text-gray-400">Share your insights, updates, or educational posts about waste management.</p>
    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea name="summary"
                                  ...
                                  class="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">{{ old('content') }}</textarea>
                    </div>
                    @error('summary')
                        <p class="mt-2 text-sm text-red-600 dark:text-red-400 flex items-center">
                            <i class="ri-error-warning-line mr-1"></i> {{ $message }}
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-green-700 dark:text-green-400">
                    <p>Write blogs that raise awareness about proper waste management, recycling practices, and eco-friendly habits. You can also attach related videos or images to make your post more engaging.</p>
                </div>
            </div>
        </div>
    </div>
